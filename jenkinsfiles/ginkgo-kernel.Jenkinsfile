            ...
            steps {
                ...
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:bd83737e9efaf85fc6d495a57222c1f6de6783aa@sha256:6872551a0276fe794ec9e65bd251857badc6d2e531b5982c5bd1e803bd115fba"
                    }
                }
            }
        }
