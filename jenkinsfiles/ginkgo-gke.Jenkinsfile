            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:bd8a4e35c8a911dd8a505855498af609bf6bf738@sha256:a730275a3b027f654250bd65b5c6c92c105fa9866c07137012c16055e87bf3ee"
                    }
                }
            }
        }
