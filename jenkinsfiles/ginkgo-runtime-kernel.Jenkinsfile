...
pipeline {
    ...
    environment {
        ...
        BASE_IMAGE="""${sh(
                returnStdout: true,
                script: 'if [ "${run_with_race_detection}" = "" ]; then echo -n "scratch"; else echo -n "quay.io/cilium/cilium-runtime:bd8a4e35c8a911dd8a505855498af609bf6bf738@sha256:a730275a3b027f654250bd65b5c6c92c105fa9866c07137012c16055e87bf3ee"; fi'
            )}"""
    }
